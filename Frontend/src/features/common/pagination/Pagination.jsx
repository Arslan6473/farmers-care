                            ...
                            </div>
                            {
                                Array.from({ length: totalPages }).map((el, index) => (
                                    <div
                                        ...
                                        className={`relative inline-flex items-center  px-4 py-2 ${index + 1 === page ? 'bg-[#256550] text-white' : 'text-gray-400'} cursor-pointer  ring-1 ring-inset ring-gray-300  focus:z-20 focus:outline-offset-0`}
                                    >
                                        {index + 1}
                                    </div>
                                ))
